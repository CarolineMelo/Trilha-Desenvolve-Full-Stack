...
// function media(nota){
//     const somaNotas = nota.reduce((acum, atual) =>
//     atual + acum , 0)/notas.length
//     return somaNotas
// }
    

// console.log(`A média é ${media(notas)}`)

const notas = [10 , 6.5 , 8 , 7]
                                //acumulo no parametro sempre tem que ser o primeiro
const somaNotas = notas.reduce((acum, atual) =>
atual + acum , 0)/notas.length

console.log(`A média é ${somaNotas}`)